...
class Simi_Siminotification_Adminhtml_SiminotificationController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function massDeleteAction() {
        ...
        if (!is_array($messageIds)) {
            ...
            try {
                ...
                Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('adminhtml')->__('Total of %d record(s) were successfully deleted', count($messageIds)));
            } catch (Exception $e) {
                Mage::getSingleton('adminhtml/session')->addError($e->getMessage());
            }
        }
    ...
    public function sendIOS($collectionDevice, $data) {
        ...
        foreach ($collectionDevice as $item) {
            ...
            if (isset($data['notice_sanbox']) && (int) $data['notice_sanbox'] == 1 && (int) $data['device_id'] == 1) {
